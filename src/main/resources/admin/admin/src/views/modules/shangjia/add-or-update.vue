<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商家电话" prop="shangjiadianhua">
          <el-input v-model="ruleForm.shangjiadianhua" 
              placeholder="商家电话" clearable  :readonly="ro.shangjiadianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商家电话" prop="shangjiadianhua">
              <el-input v-model="ruleForm.shangjiadianhua" 
                placeholder="商家电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='shangjiadianhua'){
            this.ruleForm.shangjiadianhua = obj[o];
	    this.ro.shangjiadianhua = true;
            continue;
          }
          if(o=='touxiang'){
