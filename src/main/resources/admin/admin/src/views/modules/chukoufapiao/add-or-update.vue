<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="发票单号" prop="fapiaodanhao">
            <el-input v-model="ruleForm.fapiaodanhao" 
                placeholder="发票单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fapiaodanhao" label="发票单号" prop="fapiaodanhao">
              <el-input v-model="ruleForm.fapiaodanhao" 
                placeholder="发票单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="发票信息" prop="fapiaoxinxi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.fapiaoxinxi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fapiaoxinxi" label="发票信息" prop="fapiaoxinxi">
                    <span v-html="ruleForm.fapiaoxinxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='fapiaodanhao'){
            this.ruleForm.fapiaodanhao = obj[o];
	    this.ro.fapiaodanhao = true;
            continue;
          }
	    ...
	    this.ro.shijian = true;
          ...
          if(o=='fapiaoxinxi'){
            this.ruleForm.fapiaoxinxi = obj[o];
	    this.ro.fapiaoxinxi = true;
            continue;
          }
          if(o=='maijiazhanghao'){
	...
	this.ruleForm.fapiaoxinxi = this.ruleForm.fapiaoxinxi.replace(reg,'../../../springboot7l0u0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chukoufapiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chukoufapiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
