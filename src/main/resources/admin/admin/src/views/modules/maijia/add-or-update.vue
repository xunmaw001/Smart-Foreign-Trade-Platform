<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="买家电话" prop="maijiadianhua">
          <el-input v-model="ruleForm.maijiadianhua" 
              placeholder="买家电话" clearable  :readonly="ro.maijiadianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="买家电话" prop="maijiadianhua">
              <el-input v-model="ruleForm.maijiadianhua" 
                placeholder="买家电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='maijiadianhua'){
            this.ruleForm.maijiadianhua = obj[o];
	    this.ro.maijiadianhua = true;
            continue;
          }
          if(o=='touxiang'){
