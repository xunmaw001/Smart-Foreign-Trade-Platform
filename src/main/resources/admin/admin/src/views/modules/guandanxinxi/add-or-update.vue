<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="关单编号" prop="guandanbianhao">
            <el-input v-model="ruleForm.guandanbianhao" 
                placeholder="关单编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.guandanbianhao" label="关单编号" prop="guandanbianhao">
              <el-input v-model="ruleForm.guandanbianhao" 
                placeholder="关单编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="关单时间" prop="guandanshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.guandanshijian" 
                type="date"
                :readonly="ro.guandanshijian"
                placeholder="关单时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.guandanshijian" label="关单时间" prop="guandanshijian">
              <el-input v-model="ruleForm.guandanshijian" 
                placeholder="关单时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="关单备注" prop="guandanbeizhu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.guandanbeizhu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.guandanbeizhu" label="关单备注" prop="guandanbeizhu">
                    <span v-html="ruleForm.guandanbeizhu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.guandanshijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='guandanbianhao'){
            this.ruleForm.guandanbianhao = obj[o];
	    this.ro.guandanbianhao = true;
            continue;
          }
	    ...
	    this.ro.shangpinfenlei = true;
          ...
          if(o=='guandanshijian'){
            this.ruleForm.guandanshijian = obj[o];
	    this.ro.guandanshijian = true;
            continue;
          }
          if(o=='guandanbeizhu'){
            this.ruleForm.guandanbeizhu = obj[o];
	    this.ro.guandanbeizhu = true;
            continue;
          }
          if(o=='maijiazhanghao'){
	...
	this.ruleForm.guandanbeizhu = this.ruleForm.guandanbeizhu.replace(reg,'../../../springboot7l0u0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `guandanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.guandanxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
