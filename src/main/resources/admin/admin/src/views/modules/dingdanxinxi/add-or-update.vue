    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="订单详情" prop="dingdanxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.dingdanxiangqing" label="订单详情" prop="dingdanxiangqing">
                    <span v-html="ruleForm.dingdanxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.dingdanxiangqing = this.ruleForm.dingdanxiangqing.replace(reg,'../../../springboot7l0u0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
