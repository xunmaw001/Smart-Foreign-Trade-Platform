      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="买家账号" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.maijiazhanghao" autocomplete="off" placeholder="买家账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='maijia'" class="input-group">
			...
			<el-form-item label="买家姓名" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.maijiaxingming" autocomplete="off" placeholder="买家姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">买家电话</div>
			   <div class="input-container">
			     <input v-model="ruleForm.maijiadianhua" class="input" type="text" placeholder="买家电话">
			   </div>
			 </div> -->
			<el-form-item label="买家电话" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.maijiadianhua" autocomplete="off" placeholder="买家电话"  />
			</el-form-item>
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">商家电话</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shangjiadianhua" class="input" type="text" placeholder="商家电话">
			   </div>
			 </div> -->
			<el-form-item label="商家电话" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangjiadianhua" autocomplete="off" placeholder="商家电话"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`maijia` == this.tableName && this.ruleForm.maijiadianhua&&(!this.$validate.isMobile(this.ruleForm.maijiadianhua))){
