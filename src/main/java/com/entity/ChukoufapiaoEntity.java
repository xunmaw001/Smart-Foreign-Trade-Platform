...
public class ChukoufapiaoEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ChukoufapiaoEntity() {
		
	}
	
	public ChukoufapiaoEntity(T t) {
		try {
	 ...
	 * 设置：发票单号
	 */
	public void setFapiaodanhao(String fapiaodanhao) {
		this.fapiaodanhao = fapiaodanhao;
	}
	/**
	 * 获取：发票单号
	 */
	public String getFapiaodanhao() {
		return fapiaodanhao;
	}
	/**
	 * 设置：商家账号
